...
function DigitalCollectibles() {
    return (
        <main  className='digital-collect-container fixed-container relative' id='digital-collectibles'>
            ...
            data-aos-duration="900" className='digital-collect-desc'>Imagine owning superhero IP before it made headlines. We're at the starting line of a digital IP innovation race, and a few fortunate early adopters are about to pilot the next wave of superhero market adoption. Rising to champion this movement is Superheroine Era.</p>
            <DigitalCollectCard />
